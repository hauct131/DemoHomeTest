...
[Image: 36564341504915]

**Previous Article - [Get Started](get-started-with-optisigns-api.md)**

**Next Article - [Tutorial: Create, Update, Add, Remove Items from Playlists](tutorial-create-update-add-remove-items-from-playlists.md)**