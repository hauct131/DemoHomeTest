...
└────────────────┬────────────────┬───────────────────────┘
    ...
    │    Output Generation    │
    ├────────────┬────────────┤
    │data/output/│ data/out/  │ data/out/
    │articles/*.md│chunks.jsonl│audit_rep.
    └────────────┴────────────┘
```
...
# Không cần thay đổi markdown_converter.py!
```
...
```python
# 1. Thêm hàm trong html_cleaner.py
# src/html_cleaner.py
