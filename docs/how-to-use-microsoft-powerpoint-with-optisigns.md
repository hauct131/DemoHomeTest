...
[Image: powerpoint tutorial image showing interior of a room]
...
4. Click [**Upload Files**](how-to-upload-manage-your-files-assets.md)
5. **Drag** in or **select** your PowerPoint file from your device
6. Click **Upload**
 **[Image: chrome\_g1LHNs2Iy9.png]**
...
2. Go to **Files/Assets**, then **Apps,** and search for the **PowerPoint Online** app.
 [Image: AD\_4nXctyxphw64S7IffhAlKONz2CBtl9SM2hYnvL72AVhnlzbT1d3BSe\_gnLGsrsRdWmB5TgjhXdOspMocHyc3dr\_n3ExHZkoTWhf5wUz8wZLhk6oTEdNfuLrTx\_cu4ShuD9Kfli5XmQCbaOevOCPUN9vJEiR\_2]
3. Click “**Log In With Microsoft**” in the OptiSigns app.
4. **Select the PowerPoint file** you wish to display.
 [Image: chrome\_HitDNka7Wp.png]
...
2. Navigate to the **File** tab, select **Share**, and then click **Embed**.
 [Image: chrome\_9JwlCn8RzV.png]
3. **Copy** the HTML embed code.
 [Image: chrome\_sR96oO3KwU (1).png]
...
8. Go to **Files/Assets**, then **Apps,** and search for the **PowerPoint Online** app.
 [Image: chrome\_fwwQKVRzVI.png]
9. Paste the **modified embed code.**
 **[Image: chrome\_QYIejECtvB.png]**
10. Optionally, **customize the Update** **Interval** (default: 600 seconds).
11. Click **Save.**
12. [**Push to Screens**](push-contents-to-your-screens.md)
