...
OptiSigns supports a wide range of files for playback. Follow **[this guide](how-to-upload-manage-your-files-assets.md)** if you need to know how to upload files. All supported files are:
...
The individual file upload limit is 1 GB by default. This limitation can be lifted if necessary by contacting our support team at [our support team](mailto:our support team).
