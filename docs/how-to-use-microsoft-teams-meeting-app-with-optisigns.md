...
[Image: 38297330621459]

**Tips:**

Have the host start the meeting a few mins before screens are joining automatically.
It will take a device 10-15s to join the meeting, so it's not a good idea to put the Teams Meeting in a playlist. It's better to use it as single asset to take up full screen or be part of a [SplitScreen zone](how-to-create-and-use-the-split-screen-app.md).